...
# AdaSARL Inference Docker Runner Script
# This script runs AdaSARL Inference experiments in Docker
...
DATASET="seq-cifar10"
BUFFER_SIZE="200"
EXPERIMENT_ID="adasarl_inference_$(date +%Y%m%d_%H%M%S)"
GPU_ID="0"
EPOCHS="50"
BATCH_SIZE="32"
...
echo "=========================================="
echo "AdaSARL Inference Docker Runner"
echo "=========================================="
...
# Run the experiment
echo "Starting AdaSARL Inference experiment..."
docker run $GPU_FLAG \
    --rm \
